...
<template>
  ...
  >
    <div
      class="w-full max-w-3xl p-8 rounded-xl bg-white backdrop-blur-lg shadow-lg transition-all duration-300 hover:shadow-xl relative overflow-hidden"
    >
      <div
